...
public class SecurityConstants {
    ...
    public static final String[] PUBLIC_URLS = { "/api/authentication/register", "/api/authentication/login", "/api/user/image/**", "/api/categories", "/api/hotels","/api/hotel/image/**", "/api/rooms", "/api/room/**","/api/room/image/**",};
